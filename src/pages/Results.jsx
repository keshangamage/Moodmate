        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-8 mb-6">
          <div className="text-center space-y-4">
            ...
            {latest.activities && latest.activities.length > 0 && (
              <div className="mt-6">
                <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-700 dark:text-gray-200">Today's Activities</h3>
                  ...
                  {latest.activities.map((activity) => (
                    <div 
                      ...
                      className="bg-indigo-50 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-200 
                        ...
                        hover:bg-indigo-100 dark:hover:bg-indigo-900 transition-colors touch-manipulation"
                    >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-8 mb-6">
            ...
            <div className="grid gap-3 sm:gap-4">
              {insights.map((insight, index) => (
                <div 
                  key={index}
                  className={`p-4 rounded-xl text-sm sm:text-base transition-all touch-manipulation
